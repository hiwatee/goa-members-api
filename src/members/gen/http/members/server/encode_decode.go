...
//
// members HTTP server encoders and decoders
//
// Command:
...
// EncodeAddResponse returns an encoder for responses returned by the members
// add endpoint.
...
// DecodeAddRequest returns a decoder for requests sent to the members add
// endpoint.
