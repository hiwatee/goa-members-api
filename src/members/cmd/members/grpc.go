...
func handleGRPCServer(ctx context.Context, u *url.URL, membersEndpoints *members.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		membersServer = memberssvr.New(membersEndpoints, nil)
	}
	...
	memberspb.RegisterMembersServer(srv, membersServer)
